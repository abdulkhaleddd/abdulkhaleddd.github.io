...
<div class="solutions-section">
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">COSMIC</span>
      <span class="solution-clue">Stellar comedian maintains element of surprise (6)</span>
      <span class="solution-breakdown">CO{S}MIC — COMIC (comedian) around S</span>
    </div>
  </div>
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">DURESS</span>
      <span class="solution-clue">Pressure wound essentially covered by bandage (6)</span>
      <span class="solution-breakdown">D{U}RESS — wound essentially (middle letter) covered by dress (bandage)</span>
    </div>
  </div>
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">ROTE</span>
      <span class="solution-clue">Communicated out loud without thinking (4)</span>
      <span class="solution-breakdown">[WROTE]~[ROTE] — rote is the process of learning through repetition, rather than learning</span>
    </div>
  </div>
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">DEBT</span>
      <span class="solution-clue">Bond perhaps returned toy bear, hugging boy's face (4)</span>
      <span class="solution-breakdown">[T{B}ED]&lt; — reversal of TED (toy bear) over (b)oy</span>
    </div>
  </div>
...
<div class="solutions-section">
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">STERILE</span>
      <span class="solution-clue">Steps to keep emergency room germ-free (7)</span>
      <span class="solution-breakdown">ST{ER}ILE — STILE (Steps) around ER</span>
    </div>
  </div>
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">IN THE ZONE</span>
      <span class="solution-clue">Relaxing, he's into Zen — shunning society, being focused (2,3,4)</span>
      <span class="solution-breakdown">(HE[s]INTOZEN)* — anagram of he's into zen without (s)ociety</span>
    </div>
  </div>
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      <span class="solution-answer">ASSERTIVE</span>
      <span class="solution-clue">Firm advertises artificial diamonds being given away (9)</span>
      <span class="solution-breakdown">(A[d]VERTISES)* — anagram of advertises without (d)iamonds</span>
    </div>
  </div>
  ...
  <div class="solution-entry">
    ...
    <div class="solution-content">
      ...
      <span class="solution-clue">Drop show's curtains before loves finally begun (5)</span>
      <span class="solution-breakdown">S[ho]W + OO + N — outer letter of show + 'o + o' for 'loves' + last letter of begun</span>
    </div>
  </div>
